    ...
    <Layout>
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4 px-6 md:px-0 pt-6 md:pt-0">
         <div>
            ...
            <p className="text-gray-500 text-sm md:text-base">Descubra novos conteúdos da comunidade.</p>
         </div>
         ...
         <div className="flex gap-3 w-full md:w-auto">
            <div className="relative flex-1 md:w-80">
                ...
                <input 
                  ...
                  className="w-full bg-white border border-gray-200 pl-10 pr-4 py-2.5 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent shadow-sm transition-all"
                />
            </div>
            <button className="bg-white border border-gray-200 px-4 py-2.5 rounded-lg text-gray-600 hover:bg-gray-50 shadow-sm transition">
                <FaFilter />
            </button>
            <button 
      ...
      <div className="px-6 md:px-0 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">
            ...
            <div 
                ...
                className="bg-white rounded-xl overflow-hidden shadow-sm border border-gray-200 group hover:shadow-lg hover:border-purple-200 hover:-translate-y-1 transition-all duration-300 cursor-pointer flex flex-col h-full"
            >
                ...
                <div className="relative h-48 md:h-64 overflow-hidden">
                   ...
                   <div className="absolute top-3 left-3 bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold text-purple-700 shadow-sm">
                       {article.tags[0]}
                   </div>
                </div>
                ...
                <div className="p-5 flex flex-col flex-1">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <span className="text-xs font-medium text-gray-600">{article.writer.fullName}</span>
                    </div>

                    <h2 className="text-lg font-bold text-gray-900 leading-tight mb-2 line-clamp-2 group-hover:text-purple-600 transition-colors">{article.headline}</h2>
                    <p className="text-gray-500 text-sm line-clamp-3 mb-4 flex-1 leading-relaxed">{article.summary}</p>
